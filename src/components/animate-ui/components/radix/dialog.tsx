  ...
  return (
    <DialogPortalPrimitive>
      ...
      >
        {children}
        {showCloseButton && (
          <DialogClosePrimitive className="fixed p-2 ring-offset-background bg-destructive focus:ring-ring data-[state=open]:bg-accent data-[state=open]:text-muted-foreground top-4 right-4 rounded-sm transition-opacity hover:opacity-100 focus:outline-hidden disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-8">
            <XIcon />
