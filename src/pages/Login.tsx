...
import { Mail, Lock, ArrowRight, Github, Sparkles, ArrowLeft } from "lucide-react";
        ...
        <div className="min-h-screen flex items-center justify-center p-4 bg-background relative overflow-hidden">
            ...
            >
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-3xl font-bold font-display tracking-tight mb-2 text-foreground">Welcome Back</h1>
                ...
                <div className="glass p-8 rounded-3xl border-cyber-primary/10 relative shadow-2xl shadow-cyber-primary/5">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <button className="flex items-center justify-center gap-2 h-11 rounded-xl glass hover:bg-white/5 transition-colors border-primary/5 text-sm font-medium">
