      ...
      >
        <div className='glass p-12 rounded-[3rem] border-cyber-primary/20 relative'>
          ...
          <p className='text-muted-foreground text-lg mb-10 leading-relaxed'>
            Welcome to the future of logistics. Your HT NEXUS AI Enterprise
          ...
          <div className='space-y-4'>
            ...
            <Link to='/'>
              <RippleButton
                variant='ghost'
                className='w-full h-12 rounded-xl text-cyber-light/60 hover:text-cyber-primary transition-colors'
              >
                <span className='flex items-center justify-center gap-2'>
                  Return to Home
          ...
          <div className='mt-12 flex justify-center items-center gap-8 border-t border-cyber-primary/10 pt-8'>
            <div className='flex flex-col items-center gap-1'>
              ...
              <span className='text-xs font-bold text-cyber-light/60 uppercase tracking-widest'>
                AI Activated
              </span>
            </div>
            <div className='flex flex-col items-center gap-1'>
